...
public class IncometaxUtil {
    ...
    public static final float THIRD_SECTION_DISCOUNT = 0.17f;
    public static final float FOURTH_SECTION_DISCOUNT = 0.2f;
    public static final float FIFTH_SECTION_DISCOUNT = 0.3f;
